...
instance Yesod App
  ...
  defaultLayout widget = do
    ...
    let menuItems =
          [ NavbarLeft
              MenuItem
              {menuItemLabel = "Home", menuItemRoute = HomeR, menuItemAccessCallback = True}
          , NavbarLeft
              MenuItem
          ...
          , NavbarLeft
              MenuItem
              {menuItemLabel = "Log", menuItemRoute = LogR, menuItemAccessCallback = isJust muser}
          , NavbarRight
              MenuItem
              { menuItemLabel = "Login"
  ...
  isAuthorized CalendarR {} _ = isAuthenticated
